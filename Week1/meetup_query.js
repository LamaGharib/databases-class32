...
const create_table_Invitee = `CREATE TABLE meetup.Invitee(
      invitee_no INT PRIMARY KEY AUTO_INCREMENT,
      invitee_name VARCHAR(50),
      invited_by VARCHAR(50))`;
const create_table_Room = `CREATE TABLE meetup.Room(
        room_no INT PRIMARY KEY AUTO_INCREMENT,
        room_name VARCHAR(50),
        floor_number INT)`;
const create_table_Meeting = `CREATE TABLE meetup.Meeting(
